...
namespace NZWalks.UI.Controllers
{
    public class RegionsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(Guid id)
        {
            ...
            var response = await client.GetFromJsonAsync<RegionDto>($"https://localhost:7008/api/regions/{id.ToString()}");
        ...
        public async Task<IActionResult> Edit(RegionDto request)
        {
            ...
            var httpRequestMessage = new HttpRequestMessage()
            {
                ...
                RequestUri = new Uri($"https://localhost:7008/api/regions/{request.Id}"),
        ...
        public async Task<IActionResult> Delete(RegionDto request)
        {
            try
            {
                ...
                var httpResponseMessage = await client.DeleteAsync($"https://localhost:7008/api/regions/{request.Id}");
